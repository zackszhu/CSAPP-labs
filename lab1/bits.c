...
int bitMask(int highbit, int lowbit) {
  ...
  int tempBit = highbit;
  int tempNum2;
  int tempNum = (((1 << tempBit) + minusOne) << 1) + 1;
  tempBit = lowbit;
  tempNum2 = (1 << tempBit) + minusOne;
  return (tempNum ^ tempNum2) & ~tempNum2;
}
/* 
...
int isLess(int x, int y) {
  int notY = ~y;  
  return  ((((x + notY + 1) & (x ^ notY)) | (x & notY)) >> 31) & 1;
}
/* 
...
int reverseBytes(int x) {
  int tempNum1 = 0xFF;
  int tempNum2 = 0xFF << 8 ;
  int tempNum3 = 0xFF << 16;
  int tempNum4 = 0xFF << 24;
  x = ((x >> 24) & tempNum1) | ((x >> 8 & tempNum2)) | ((x << 8) & tempNum3) | ((x <<24) & tempNum4);  return x;
}
/* 
